...
export default function Platform(){return <><Header/><main>
  <section className="page-hero plan-hero"><div className="wrap"><p className="eyebrow light">THE LCA COMMON PROGRAM</p><h1>Three parties.<br/>One way forward.</h1><p className="page-hero-description">A shared program for stable government, stronger communities and a Caprica confident enough to build its future.</p><a className="manifesto-download" href="/manifesto/caprica-new-future-2064.pdf" target="_blank" rel="noreferrer" aria-label="Read our 2064 manifesto PDF in a new tab"><span>READ OUR MANIFESTO</span><ArrowIcon/></a></div></section>
  <section className="alliance-intro wrap section-pad" id="alliance"><p className="eyebrow">THE ALLIANCE</p><h2>Agreement where it matters.</h2><div><p className="lead">LCA unites three distinct political traditions behind one program for the 2064 election.</p><p>We will govern from common ground, protect constitutional democracy, reward work and enterprise, deliver dependable public services, and give every region a genuine stake in national progress. Our parties retain their identities. Our candidates share one commitment, a capable, open and forward-looking Caprica.</p></div></section>
