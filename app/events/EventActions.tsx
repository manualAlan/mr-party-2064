...
export function VolunteerForm(){
 const [sent,setSent]=useState(false);
 if(sent) return <div className="form-success compact-success"><span>WELCOME TO THE TEAM</span><h3>You’re in.</h3><p>Your local LCA organizer would follow up from the live campaign system.</p><button type="button" onClick={()=>setSent(false)}>Start over</button></div>;
